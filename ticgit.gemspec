...
Gem::Specification.new do |s|
  s.name = %q{ticgit}
  s.version = "2010.09.03"

  s.required_rubygems_version = Gem::Requirement.new(">= 0") if s.respond_to? :required_rubygems_version=
  s.authors = ["Scott Chacon", "Michael 'manveru' Fellinger", "Jeff Welling"]
  s.date = %q{2010-09-03}
  s.default_executable = %q{ti}
  s.email = %q{jeff.welling@gmail.com}
  s.executables = ["ti", "ticgitweb"]
  s.files = [".gitignore", "AUTHORS", "LICENSE", "README", "Rakefile", "bin/ti", "bin/ticgitweb", "examples/post-commit", "lib/ticgit.rb", "lib/ticgit/base.rb", "lib/ticgit/cli.rb", "lib/ticgit/command.rb", "lib/ticgit/command/assign.rb", "lib/ticgit/command/checkout.rb", "lib/ticgit/command/comment.rb", "lib/ticgit/command/list.rb", "lib/ticgit/command/milestone.rb", "lib/ticgit/command/new.rb", "lib/ticgit/command/points.rb", "lib/ticgit/command/recent.rb", "lib/ticgit/command/show.rb", "lib/ticgit/command/state.rb", "lib/ticgit/command/tag.rb", "lib/ticgit/comment.rb", "lib/ticgit/ticket.rb", "lib/ticgit/version.rb", "note/IMPLEMENT", "note/NOTES", "note/OUTPUT", "note/TODO", "spec/helper.rb", "spec/ticgit/base.rb", "spec/ticgit/cli.rb", "spec/ticgit/command/new.rb", "spec/ticgit/command/points.rb", "spec/ticgit/command/state.rb", "spec/ticgit/open.rb", "tasks/authors.rake", "tasks/bacon.rake", "tasks/changelog.rake", "tasks/cucumber.rake", "tasks/gem.rake", "tasks/gem_installer.rake", "tasks/git.rake", "tasks/grancher.rake", "tasks/install_dependencies.rake", "tasks/manifest.rake", "tasks/metric_changes.rake", "tasks/rcov.rake", "tasks/release.rake", "tasks/reversion.rake", "tasks/setup.rake", "tasks/todo.rake", "tasks/traits.rake", "tasks/yard.rake", "tasks/ycov.rake", "ticgit.gemspec"]
  s.has_rdoc = true
  s.homepage = %q{http://github.com/jeffWelling/ticgit}
  s.require_paths = ["lib"]
